...
public class Vigenere {
    ...
    private static final String INSTRUCTIONS = "\nInstructions pour le chiffrement de Vigenère :" +
            "\n1. Entrez votre message (lettres et espaces autorisés uniquement)" +
            "\n2. Entrez une clé de chiffrement (minimum 3 lettres, sans espaces)" +
            "\n3. Les espaces seront conservés tels quels" +
    ...
    private static boolean validerTexte(String texte) {
        ...
        if (!texte.matches("[a-zA-Z ]*")) {
            System.out.println("Seules les lettres et les espaces sont autorisés");
            return false;
        }
    ...
    public static String chiffrer(String messageAChiffrer, String cleDeChiffrement) {
        ...
        for (int i = 0; i < longueurMessage; i++) {
            ...
            char caractereCle = cleDeChiffrement.charAt(i % cleDeChiffrement.length());
